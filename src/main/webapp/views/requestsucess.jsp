...
<div class="container profile">
  ...
  <div class="card-body">
    <br>
   <b> <h2 class="card-text"><i class="fa fa-check-circle" style="font-size:60px;color:green"></i></h2></b>
   <p>Congratulations <b><%=session.getAttribute("uname") %> </b>your request for <b>Loan application</b> has been recorded sucessfully.. <br>Our manager will contact you soon.. </p>
     <br><br><a href="/status"><button type="button" class="btn btn-success">Click me</button></a>
  </div>
</div>
