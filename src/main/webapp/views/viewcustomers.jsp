  ...
  <a href="/landing"><i class="fa fa-sign-out"></i>Logout</a>
    ...
    <div class="div1">&nbsp;&nbsp;&nbsp;<b>&nbsp;&nbsp;&nbsp;&nbsp;Welome: <%=session.getAttribute("uname") %></b></div><hr>
     ...
     <table id="customers" >
            <thead>
                <tr>
                    <th>Customer Name&nbsp;<i class="fa fa-filter" aria-hidden="true" style="color:white"></i></th>
                    <th>Customer Email&nbsp;<i class="fa fa-filter" aria-hidden="true" style="color:white"></i></th>
                    <th>Account Number&nbsp;<i class="fa fa-filter" aria-hidden="true" style="color:white"></i></th>
                    <th>Customer Mobile</th>
                   
                     <th>Customer Recent Login</th>
                       <th>Customer Status&nbsp;<i class="fa fa-filter" aria-hidden="true" style="color:white"></i></th>
                       <th>More</th>
                ...
                <tr>
                  ...
                  <th><input type="text" id="myInput" class="w3-input w3-border" onkeyup="myFunction()" placeholder="Search name.." size="8" height="48"></th>
                   <th><input type="text" id="myInput1" class="w3-input w3-border" onkeyup="myFunction1()" placeholder="Search email.." size="8" height="48"></th>
                   ...
                   <th></th>
                    <th></th>
                   <th><input type="radio" name="status" value="1" id="myInput3" onkeyup="myFunction3()">Active<br><input type="radio" name="status" value="0" style="color:green;">Inactive</th>
                    <th></th>
                
                </tr>
            </thead>
           
        <c:forEach var="emp" items="${cudata}">
            <tr>
                <td>${emp.name}</td>
                <td>${emp.email}</td>
