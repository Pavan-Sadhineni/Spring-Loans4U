...
<div class="container profile">
  ...
  <a href="/customerlogout/Loans<%=session.getAttribute("email") %>"><i class="fa fa-sign-out"></i>Logout</a>
  </div>
</div>
    <div class="div1">&nbsp;&nbsp;&nbsp;<b>Welome: <%=session.getAttribute("uname") %></b></div><hr>
    
    <p style="text-align:center;">***** Hello <%=session.getAttribute("uname") %> you are eligible in taking up the loan *****</p>
    <br>
    
    
    <div class="ct-find-service">

     <form style="text-align:center;" action="/proceed" method="post">
  <b><label for="cars"><h3 style="color:white;"><b>Choose Loan Type:</b></h3>&nbsp;&nbsp;&nbsp;</label></b>
  	<div class="ct-select-group ct-js-select-group">
  <select class="ct-select ct-js-select" name="Loans" id="Loans">
      <option value=""><p>Select Your Loan here..</p></option>
      <option value=31435>Home Loan</option>
      <option value="edu">Educational Loan</option>
    
   
  </select>
  </div>
  <br><br><label for="cars">&nbsp;&nbsp;&nbsp;</label>
