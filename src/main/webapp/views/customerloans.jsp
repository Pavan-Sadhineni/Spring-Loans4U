...
<div class="container profile">
  ...
  <div class="card-body">
    <h1> <i class='fas fa-balance-scale-right' style='font-size:100px;color:#32a852;'></i></h1><br>
   <b> <p class="card-text">Apply For New Loan</p></b><br>
    <a href="/customer/selectloan"><button type="button" class="btn btn-primary">Apply&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></button></a>
    <br><br>
  </div>
</div>
 ...
 <div class="card" style="width: 15rem;">
  ...
  <div class="card-body">
    <h1><i class='fas fa-shield-alt' style='font-size:100px;color:#32a852'></i></h1><br>
   <b><p class="card-text">Check Your Loan Status</p></b> <br>
   <a href="/status"> <button type="button" class="btn btn-primary">Check</i></button></a>
    <br><br>
  </div>
</div>
...
<div class="card" style="width: 15rem;">
  ...
  <div class="card-body">
    <h1> <i class="fa fa-exchange" aria-hidden="true" style='font-size:100px;color:#32a852'></i></p></h1><br>
   <b> <p class="card-text">View Your Transactions</p></b><br>
    <button type="button" class="btn btn-primary">View&nbsp;&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></button>
    <br><br>
  </div>
</div>
...
<div class="card" style="width: 15rem;">
  ...
  <div class="card-body">
    <h1><i class="fa fa-upload" aria-hidden="true" style='font-size:100px;color:#32a852'></i></p></h1><br>
   <b><p class="card-text">Upload Your Documents</p></b><br>
    <a href="customer/uploaddocuments/"> <button type="button" class="btn btn-primary">Upload&nbsp;&nbsp;<i class="fa fa-upload" aria-hidden="true"></i></button></a>
    <br><br>
  </div>
</div>
