...
<div class="container profile">
   ...
   <a class="navbar-brand" href="#">&nbsp;&nbsp;<img alt="" src="images/logo.png"  width=100px></a>
  ...
  <a href="#contact">Contact</a>
    ...
    <div class="div1">&nbsp;&nbsp;&nbsp;<b>Login to Loans4U</b></div><hr>
      <div class="body1">
   
     <form method="post" action="/login" style="display:inline;" >  <div class="name2" style="display:inline-block;">
     ...
     <input type="submit" value="Login" class="btn btn-info"> &nbsp;&nbsp;&nbsp; <input type="reset" value="Reset" class="btn btn-info"></p>
     ...
     <img alt="" src="images/logo.png" style="display:inline;" width=50%>
